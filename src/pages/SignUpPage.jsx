...
export default function SignUpPage() {
  ...
  return (
    <>
      ...
      {i18n.language == "en" && 
          <button className="btn  p-2 text-black " style={{border:"0"}}
            onClick={() => {
       ...
       {i18n.language =='ar'&& <button className=" btn btn-outline  p-2 text-black " style={{border:"0" , }}
          onClick={() => {
        ...
        <Row className="justify-content-center">
          ...
          <div className="text-center">
            ...
            <Card className="p-4">
              ...
              <Form onSubmit={handleSubmit}>
                <Form.Group className="mb-3" controlId="formBasicName">
                  ...
                  <Form.Control
                    type="text"
                    placeholder={t('user.First and last name')}
                    value={name}
                    style={{
                ...
                <Form.Group className="mb-3" controlId="formBasicEmail">
                  ...
                  <Form.Control
                    type="email"
                    placeholder={t('user.Enter email')}
                    value={email}
                    style={{
                      border:"0.0625rem grey solid",
                      borderRadius:"0.625rem"
                ...
                <Form.Group className="mb-3" controlId="formBasicPassword">
                  ...
                  <Form.Control
                    type="password"
                    placeholder={t('user.At least 6 characters')}
                    value={password}
                    style={{
                      border:"0.0625rem grey solid",
                      borderRadius:"0.625rem"
           ...
           <Button variant="warning blod " type="submit" className="w-100 ">
                ...
                <CardText
                  class="para_text"
                  style={{ marginTop: "2em", textAlign: "start",fontSize:"small" }}
                >
                  {t('user.By continuing, you agree to Amazons')}{" "}
                  <a
                    href="https://www.amazon.com/gp/aw/help/ref=ap_mobile_register_notification_condition_of_use?id=508088"
                    target="blank"
                  >
                    {t('user.Conditions of Use')}
                  </a>{" "}
                  and{" "}
                  <a
              ...
              <div className="mt-3" style={{ textAlign: "start" }}>
                ...
                <br />
                <hr />
                <b>{t('user.Bying for work?')}</b>
                <br />
                <CardLink
                  href="https://www.amazon.com/business/register/org/landing?ref_=ap_altreg_ab"
                  style={{ textDecoration: "none" }}
                >
                  {t('user.Create a free business account')}
                </CardLink>
                <br />
                <hr />
                <span>{t('user.Already have an account?')}</span>{" "}
                <Link to={`/signin`}>
                  {t('user.Sign in')}
                </Link>
              </div>
