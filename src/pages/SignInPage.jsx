       ...
       {i18n.language =='ar'&& <button className=" btn btn-outline  p-2 text-black " style={{border:"0" , }}
        ...
        <Row className="justify-content-center">
          <Col lg={4} md={6} className="text-center">
            ...
            <Card className="p-4">
              <h2 className="d-flex w-100 fs-5 text-left" style={{ textAlign: "start" }}>
                {t('user.Sign In')}
              </h2>
              ...
              <Form onSubmit={handleSubmit}>
                <Form.Group className="my-3" controlId="formBasicEmail">
                  ...
                  >
                    {t('user.Email or mobile phone number')}
                  </Form.Label>
                  <Form.Control
                    id="email"
                    type="email"
                ...
                <CardText
                  className="para_text"
                  style={{ marginTop: "2em", textAlign: "start" }}
                >
              ...
              <div className="mt-3" style={{ textAlign: "start" }}>
                ...
                >
                  {t('user.Shop on Amazon Business')}
                </CardLink>
              </div>
            </Card>
            <HrText text={t('user.New to Amazon?')} />
            <div className="a-divider a-divider-break">
              <Link to={`/signup`}>
                <Button variant="outline-secondary" className="w-100">
                  {t('user.Create your Amazon account')}
                </Button>
              </Link>
            </div>
          </Col>
