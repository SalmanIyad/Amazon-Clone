    ...
    <footer>
      <section className="text-white d-none d-md-inline-block w-100">
        <div className="navbar-footer">
          <a href="#top">
            {" "}
            <i className="fa-solid fa-caret-up"></i>{t('footer.topofPage')}{" "}
          </a>
        </div>
        ...
        <div className="container">
          <div className="row py-4">
            <div className="col-lg-3 col-md-6 mb-4">
              <h5 className="text-uppercase">{t('footer.GettoKnowUs')}</h5>
            ...
            <div className="col-lg-3 col-md-6 mb-4">
              <h5 className="text-uppercase">{t('footer.Make Money with Us')}</h5>
              <ul className="list-unstyled">
                <li>
                  <a href="#" className="text-white">
                    {t('footer.Sell products on Amazon')}
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white">
                    {t('footer.Sell on Amazon Business')}
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white">
                    {t('footer.Sell apps on Amazon')}
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white">
                ...
                <li>
                  <a href="#" className="text-white">
                    {t('footer.Self-Publish with Us')}
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white">
                   {t('footer.Host an Amazon Hub')}
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white">
                    <i className="fa-solid fa-angle-right"></i> 
                    {t('footer.See More Make Money with Us')}
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className="col-lg-3 col-md-6 mb-3">
              <h5 className="text-uppercase">{t('footer.Amazon Payment Products')}</h5>
              <ul className="list-unstyled">
                <li>
                  <a href="#" className="text-white">
                   {t('footer.Amazon Business Card')}
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white">
                    {t('footer.Shop With Points')}
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white">
                    {t('footer.Reload Your Balance')}
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white">
                    {t('footer.Amazon Currency Converter')}
                  </a>
                </li>
              </ul>
            </div>
            ...
            <div className="col-lg-3 col-md-6 mb-4">
              <h5 className="text-uppercase">{t('footer.Let Us Help You')}</h5>
              <ul className="list-unstyled">
                <li>
                  <a href="#" className="text-white">
                    {t('footer.Amazon and COVID-19')}
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white">
                ...
                <li>
                  <a href="#" className="text-white">
                    {t('footer.Manage Your Content and Devices')}
                  </a>
                </li>
                <li>
                  <a href="#" className="text-white">
      ...
      <section className="d-md-none bg-dark">
          ...
          <div className="d-flex flex-row m-3">
            <div className="col-6">
              <ul className="FooterUl p-1">
                <li>Amazon.com</li>
                <li>{t('footer.Your Orders')}</li>
                <li>{t('footer.Your Lists')}</li>
                <li>{t('footer.Gift Cards')}</li>
                <li>{t('footer.Registry & Gift List')} </li>
                <li>{t('footer.Find a Gift')}</li>
                <li>{t('footer.Your Account')}</li>
              </ul>
            </div>
            <div className="col-6 p-1">
              <ul className="FooterUl">
                <li>{t('footer.Browsing History')}</li>
                <li>{t('footer.Returns')}</li>
                <li>{t('footer.Recalls and Product')}</li>
                <li>{t('footer.Safety Alerts')}</li>
                <li></li>
              </ul>
            </div>
          </div>
       ...
       {i18n.language =='ar'&& <button className="btn bg-dark p-2 text-white " style={{border:"0"}}
        ...
        >
          ...
          <span className="text-white">{t('footer.Already a customer? Sign in')}</span>
        </div>
      </section>
    </footer>
  );
